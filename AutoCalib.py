...
bottomWidth = (pts[3][0] - pts[0][0])/8
bottomHeight = (pts[3][1] - pts[0][1])/8

topWidth = (pts[2][0] - pts[1][0])/8
topHeight = (pts[2][1] - pts[1][1])/8

blackBW = bottomWidth/4
blackBH = bottomHeight/4
blackTW = topWidth/4
blackTH = topHeight/4
